...
public class QRCodeReaderView extends SurfaceView
    ...
    private static final long RESET_CAMERA_DELAY = 1000;
    ...
    private double ratioFinderLeft, ratioFinderTop, ratioFinderWidth, ratioFinderHeight;
    private boolean useDefaultFinderRatio = true;

    SurfaceHolder lastHolder;
    ...
    public void setFinderRatio(double ratioFinderLeft, double ratioFinderTop, double ratioFinderWidth, double ratioFinderHeight) {
        useDefaultFinderRatio = false;
        this.ratioFinderLeft = ratioFinderLeft;
        this.ratioFinderTop = ratioFinderTop;
        this.ratioFinderWidth = ratioFinderWidth;
        this.ratioFinderHeight = ratioFinderHeight;
    }
        ...
        if (mCameraManager.isOpen()) {
            ...
            post(() -> {
                ...
                try {
                    ...
                    mCameraManager.openDriver(lastHolder, this.getWidth(), this.getHeight());
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        ...
        if (useDefaultFinderRatio) {
            ratioFinderLeft = 0;
            ratioFinderTop = 0;
            ratioFinderWidth = 100;
            ratioFinderHeight = 100;
        }

        //todo : fix for rotation screen
//        mCameraManager.stopPreview();
...
//                    view.mCameraManager.buildLuminanceSource(
//                            params[0],
//                            view.mPreviewWidth,
//                            view.mPreviewHeight ,
//                            new Rect(243 , 377 , 556 , 102)
//                    );

            final PlanarYUVLuminanceSource source = getSource(params);
            ...
            try {
                ...
                SimpleLog.d(TAG, "NullPointerException", e);
            } catch (IllegalArgumentException t) {
                SimpleLog.d(TAG, "IllegalArgumentException", t);
            } finally {
                if (view.mQRCodeReader != null)
        ...
        private PlanarYUVLuminanceSource getSource(byte[][] params) {
            QRCodeReaderView view = viewRef.get();
            return new PlanarYUVLuminanceSource(
                    params[0],
                    view.mPreviewWidth,
                    view.mPreviewHeight,
                    (int) (view.mPreviewWidth * getPercent(view.ratioFinderTop)),
                    (int) (view.mPreviewHeight * getPercent(view.ratioFinderLeft)),
                    (int) (view.mPreviewWidth * getPercent(view.ratioFinderHeight)),
                    (int) (view.mPreviewHeight * getPercent(view.ratioFinderWidth)),
                    false
            );
        }
    ...
    public boolean isShowPreview() {
        return mCameraManager.isShowPreview();
    }

    public synchronized void setShowPreview(boolean showPreview) {
        mCameraManager.setShowPreview(showPreview);
    }
}
